 ...
 * and it is what the sidebar counts ("FEEDS 4/14").
 *
...
export const SOURCES: SourceDef[] = [
  ...
  { key: 'twitterapi_io', displayName: 'Tracked accounts', category: 'sentiment', requiresKey: true, enabled: true, unlockNote: 'Choose a tweet provider: set TWEET_SOURCE=twitterapi_io and TWITTERAPI_IO_KEY, or leave it on mock.' },
